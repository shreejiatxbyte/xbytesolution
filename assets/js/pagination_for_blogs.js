    ...
    var a = {
        ...
        _draw: function () {
            var e,
                ...
                s = t.data("pagination"),
                n = a._getInterval(s);
            if ((a.destroy.call(this), s.prevText && a._appendItem.call(this, s.currentPage - 1, { text: s.prevText, classes: "prev" }), n.start > 0 && s.edges > 0)) {
                var i = Math.min(s.edges, n.start);
                for (e = 0; e < i; e++) a._appendItem.call(this, e);
                s.edges < n.start && s.ellipseText && t.append('<span class="ellipse">' + s.ellipseText + "</span>");
            }
            for (e = n.start; e < n.end; e++) a._appendItem.call(this, e);
            if (n.end < s.pages && s.edges > 0)
                for (s.pages - s.edges > n.end && s.ellipseText && t.append('<span class="ellipse">' + s.ellipseText + "</span>"), e = Math.max(s.pages - s.edges, n.end); e < s.pages; e++) a._appendItem.call(this, e);
        ...
        _appendItem: function (t, s) {
            ...
            (t = t < 0 ? 0 : t < r.pages ? t : r.pages - 1),
                ...
                t == r.currentPage || r.disabled
                    ...
                    : (i = e('<a href="' + r.hrefText + (t + 1) + '" class="page-link">' + n.text + "</a>")).click(function () {
        ...
        _selectPage: function (e) {
            ...
            (t.currentPage = e), t.selectOnClick ? (t.onPageClick(e + 1), a._draw.call(this)) : t.onPageClick(e + 1);
        },
    };
