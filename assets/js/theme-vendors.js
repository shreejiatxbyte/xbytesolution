                    ...
                    setTimeout(
                        t.proxy(function () {
                            s[n](null == o[e] ? this.options[e] : o[e]),
                                "loadingText" == e ? ((this.isLoading = !0), s.addClass(i).attr(i, i).prop(i, !0)) : this.isLoading && ((this.isLoading = !1), s.removeClass(i).removeAttr(i).prop(i, !1));
                        }, this),
                        0
                    );
            }),
                ...
                t(o).each(function () {
                    ...
                    n.hasClass("open") &&
                        ((i && "click" == i.type && /input|textarea/i.test(i.target.tagName) && t.contains(n[0], i.target)) ||
                            (n.trigger((i = t.Event("hide.bs.dropdown", o))), i.isDefaultPrevented() || (s.attr("aria-expanded", "false"), n.removeClass("open").trigger(t.Event("hidden.bs.dropdown", o)))));
                }));
        }
        function s(e) {
            return this.each(function () {
                    ...
                    (n = this),
                        (r = function (e) {
                            if (!n.isReady) {
                                ...
                                n.el &&
                                    (t.getAttribute("built-by-vivus") && (n.parentEl.insertBefore(n.el, t), n.parentEl.removeChild(t), n.el.setAttribute("width", "100%"), n.el.setAttribute("height", "100%")),
                                    (n.isReady = !0),
                                    n.init(),
                                    (n = null));
                            }
                    ...
                    this.isInvisible(r) ||
                        ...
                        isNaN(i.length)
                            ...
                            : (this.map.push(i),
                              ...
                              this.renderPath(t)));
            for (
                o = 0 === o ? 1 : o, this.delay = null === this.delay ? this.duration / 3 : this.delay, this.delayUnit = this.delay / (e.length > 1 ? e.length - 1 : 1), this.reverseStack && this.map.reverse(), t = 0;
                t < this.map.length;
                t++
            ) {
 ...
 */ !(function (a, b) {
    ...
    var Fit = {
        within: function (a, b) {
            for (
                var c = $.extend({ height: !0, width: !0 }, arguments[2] || {}), d = $.extend({}, b), e = 1, f = 5, g = { width: c.width, height: c.height };
        ...
        Window = {
            ...
            updateBoxDimensions: function () {
                ...
                if ((a = Pages.page)) {
                    ...
                    (this._boxDimensions = { width: d ? b.width : b.width - c.width, height: d ? b.height - c.height : b.height }),
                    ...
                    insertVideo: function (a) {
                        ...
                        this.content.prepend(
                            (this.playerIframe = $("<iframe webkitAllowFullScreen mozallowfullscreen allowFullScreen>")
                                ...
                                .attr({ src: f, height: this._contentDimensions.height, width: this._contentDimensions.width, frameborder: 0 }))
                        ),
                            a && a();
                    },
                    raise: function () {
    ...
    var Thumbnails = {
        ...
        updateVars: function () {
            ...
            if ((l || a.show(), this.disabled() && this.enable(), !this.element.is(":visible") || this._thumbnails.length < 2 || this._disabledGroup))
                return this.disable(), $.extend(this._vars.thumbnails, { width: 0, height: 0 }), l || a.hide(), void this.element.addClass("fr-thumbnails-measured");
            this.enable();
    ...
    return (
        (UI.fullclick = {
            ...
            hide: function (a) {
                ...
                return !this._visible || (b && ("youtube" == b || "vimeo" == b))
                    ? void ("function" == $.type(a) && a())
                    : ((this._visible = !1), Window.element.removeClass("fr-visible-fullclick-ui").addClass("fr-hidden-fullclick-ui"), void ("function" == $.type(a) && a()));
            },
            clearTimer: function () {
        ...
        (UI.inside = {
            ...
            show: function (a) {
                return this._visible
                    ? (this.startTimer(), void ("function" == $.type(a) && a()))
                    : ((this._visible = !0), this.startTimer(), Window.element.addClass("fr-visible-inside-ui").removeClass("fr-hidden-inside-ui"), void ("function" == $.type(a) && a()));
            },
            hide: function (a) {
        ...
        E = function (a, b, c, d, e, h, j) {
            ...
            if (P) {
                ...
                for (r = " " === M && (!S || (!Q && !R)), k = 0; k < P.length; k++) {
                    for (
                        q = P[k], t = f.createElement(N), t.style.cssText = "display:block;text-align:" + I + ";position:" + (S ? "absolute;" : "relative;"), T && (t.className = T + (U ? k + 1 : "")), L.push(t), m = q.length, l = 0;
                        m > l;
                        l++
                    )
                        "BR" !== q[l].nodeName &&
...
function stackBlurCanvasRGBA(a, t, e, r, n, l) {
    if (!(isNaN(l) || l < 1)) {
        ...
        var J = mul_table[l],
            K = shg_table[l];
        for (s = 0; s < n; s++) {
            for (C = k = E = R = h = x = d = v = 0, B = U * (p = G[m]), w = U * (D = G[m + 1]), y = U * (N = G[m + 2]), I = U * (_ = G[m + 3]), h += H * p, x += H * D, d += H * N, v += H * _, j = W, i = 0; i < U; i++)
        ...
        for (o = 0; o < r; o++) {
            for (k = E = R = C = x = d = v = h = 0, B = U * (p = G[(m = o << 2)]), w = U * (D = G[m + 1]), y = U * (N = G[m + 2]), I = U * (_ = G[m + 3]), h += H * p, x += H * D, d += H * N, v += H * _, j = W, i = 0; i < U; i++)
                (j.r = p), (j.g = D), (j.b = N), (j.a = _), (j = j.next);
            for (b = r, i = 1; i <= l; i++)
                (m = (b + o) << 2),
                    (h += (j.r = p = G[m]) * (S = U - i)),
                    ...
                    if (YTPlayer.isReady) {
                        ...
                        if (
                            ...
                            0 < YTPlayer.player.getPlayerState() &&
                                (parseFloat(YTPlayer.player.getDuration() - YTPlayer.opt.fadeOnStartTime / 1e3) < YTPlayer.player.getCurrentTime() || (0 < stopAt && parseFloat(YTPlayer.player.getCurrentTime()) >= stopAt)))
                        ) {
...
!(function (t) {
    ...
    function h(t, e, r, n, a) {
        ...
        return a && i[0].charAt(0) == i[0].charAt(1) && i[1].charAt(0) == i[1].charAt(1) && i[2].charAt(0) == i[2].charAt(1) && i[3].charAt(0) == i[3].charAt(1)
    ...
    (e.prototype = {
        ...
        toPercentageRgbString: function () {
            return 1 == this._a
                ? "rgb(" + $(100 * H(this._r, 255)) + "%, " + $(100 * H(this._g, 255)) + "%, " + $(100 * H(this._b, 255)) + "%)"
                : "rgba(" + $(100 * H(this._r, 255)) + "%, " + $(100 * H(this._g, 255)) + "%, " + $(100 * H(this._b, 255)) + "%, " + this._roundA + ")";
        },
        toName: function () {
